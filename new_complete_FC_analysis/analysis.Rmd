...
ggplot(data = day0_all_ages_genotype_treatment, aes(x = Time, y = len, color = Genotype)) +
  ...
  theme_bw() + 
  labs(title = 'Learning Curves by Genotype and Treatment', x = 'Sound Component', 
...
ggplot(data = day0_12_months_genotype_treatment, aes(x = Time, y = len, color = Genotype)) +
  ...
  geom_errorbar(aes(ymin = len - se, ymax = len + se), width = 0.2, size = 0.5) +
  theme_bw() + 
  labs(title = '12 Months Old Learning Curves by Genotype and Treatment', x = 'Sound Component', 
    y = 'Mean Percent Time Freezing', 
    legend = 'Genotype') +
  scale_x_continuous(breaks = c(1, 2, 3))
...
ggplot(data = day0_18_months_genotype_treatment, aes(x = Time, y = len, color = Genotype)) +
  ...
  geom_errorbar(aes(ymin = len - se, ymax = len + se), width = 0.2, size = 0.5) +
  theme_bw() + 
  labs(title = '18 Months Old Learning Curves by Genotype and Treatment', x = 'Sound Component', 
    y = 'Mean Percent Time Freezing', 
    legend = 'Genotype') +
  scale_x_continuous(breaks = c(1, 2, 3))
...
ggplot(data = day0_12_months_genotype_treatment_sex, aes(x = Time, y = len, color = Genotype)) +
  ...
  geom_errorbar(aes(ymin = len - se, ymax = len + se), width = 0.2, size = 0.5) +
  theme_bw() + 
  labs(title = '12 Months Old Learning Curves by Genotype, Sex, and Treatment', x = 'Sound Component', 
    y = 'Mean Percent Time Freezing', 
    legend = 'Genotype') +
  scale_x_continuous(breaks = c(1, 2, 3))

day0_12_months_HNs <- day0_relevant_data %>%
  filter(Age == '12 months') %>% 
...
ggplot(data = day0_12_months_HNs, aes(x = Time, y = len, color = Genotype)) +
  geom_line() +
  facet_grid(Treatment~Sex)  + 
  geom_errorbar(aes(ymin = len - se, ymax = len + se), width = 0.2, size = 0.5) +
  theme_bw() + 
  labs(title = '12 Months Old HNs Learning Curves by Genotype, Sex, and Treatment', x = 'Sound Component', 
    y = 'Mean Percent Time Freezing', 
    legend = 'Genotype') +
  scale_x_continuous(breaks = c(1, 2, 3))

day0_12_months_nonHNs <- day0_relevant_data %>%
  filter(Age == '12 months') %>% 
...
ggplot(data = day0_12_months_nonHNs, aes(x = Time, y = len, color = Genotype)) +
  geom_line() +
  facet_grid(Treatment~Sex)  + 
  geom_errorbar(aes(ymin = len - se, ymax = len + se), width = 0.2, size = 0.5) +
  theme_bw() + 
  labs(title = '12 Months Old nonHNs Learning Curves by Genotype, Sex, and Treatment', x = 'Sound Component', 
    y = 'Mean Percent Time Freezing', 
    legend = 'Genotype') +
  scale_x_continuous(breaks = c(1, 2, 3))
...
ggplot(data = day0_age_treatment_HNs, aes(x = Time, y = len, color = Age)) +
  ...
  geom_errorbar(aes(ymin = len - se, ymax = len + se), width = 0.2, size = 0.5) +
  theme_bw() + 
  labs(title = 'Learning Curves by Age, HN Genotype, and Treatment', x = 'Sound Component', 
    y = 'Mean Percent Time Freezing', 
    legend = 'Genotype') +
  scale_x_continuous(breaks = c(1, 2, 3))  
...
ggplot(data = day0_age_treatment_nonHNs, aes(x = Time, y = len, color = Age)) +
  ...
  geom_errorbar(aes(ymin = len - se, ymax = len + se), width = 0.2, size = 0.5) +
  theme_bw() + 
  labs(title = 'Learning Curves by Age, nonHN Genotype, and Treatment', x = 'Sound Component', 
    y = 'Mean Percent Time Freezing', 
    legend = 'Genotype') +
  scale_x_continuous(breaks = c(1, 2, 3))  
...
ggplot(data = day1_age_HN_genotype_treatment_pctfreezing, aes(x = Treatment, y = len, fill = Treatment)) +
  ...
  geom_errorbar(aes(ymin=len-se, ymax=len+se), width = 0.2, size = 0.5) +
  theme_bw() +
  labs(title = 'Day 1 Percent Freezing by Treatment, Age, and HN Genotype', y = 'Mean Percent Time Freezing', x = 'Treatment')
...
ggplot(data=day1_genotype_treatment_pctfreezing, aes(x=Genotype, y=len, fill=Genotype)) +
  ...
  geom_errorbar(aes(ymin=len-se, ymax=len+se), width=0.2, size=0.5) +
  theme_bw() +
  labs(title='Day 1 All Ages Percent Freezing by Treatment and Genotype', y='Mean Percent Time Freezing', x='Genotype') + 
...
ggplot(data=day1_12_months_genotype_treatment_pctfreezing, aes(x=Genotype, y=len, fill=Genotype)) +
  ...
  geom_errorbar(aes(ymin=len-se, ymax=len+se), width=0.2, size=0.5) +
  theme_bw() +
  labs(title='Day 1 12 Months Percent Freezing by Treatment and Genotype', y='Mean Percent Time Freezing', x='Genotype') + 
  theme(axis.text.x = element_text(angle = 90))
...
ggplot(data=day1_18_months_genotype_treatment_pctfreezing, aes(x=Genotype, y=len, fill=Genotype)) +
  ...
  geom_errorbar(aes(ymin=len-se, ymax=len+se), width=0.2, size=0.5) +
  theme_bw() +
  labs(title='Day 1 18 Months Percent Freezing by Treatment and Genotype', y='Mean Percent Time Freezing', x='Genotype') + 
  theme(axis.text.x = element_text(angle = 90))

ggplot(data = day1_relevant_data, aes(factor(Genotype), Pct.Total.Time.Freezing)) +
  geom_violin() +
  geom_boxplot(width = 0.1) +
  theme_bw() +
  facet_grid(.~Treatment) + 
  geom_jitter(height = 0, width = 0.3, aes(color = Genotype)) +
  labs(title='Contextual Test by Genotype and Treatment', y = 'Percent Freezing Time', x='Genotype') + 
  theme(axis.text.x = element_text(angle = 90))
...
ggplot(data = day1_relevant_data, aes(factor(Genotype), Pct.Total.Time.Freezing)) +
  ...
  facet_grid(.~Sex) + 
  geom_jitter(height = 0, width = 0.3, aes(color = Genotype)) +
  labs(title='Contextual Test by Sex and Treatment', y = 'Percent Freezing Time', x='Genotype') + 
  theme(axis.text.x = element_text(angle = 90))
